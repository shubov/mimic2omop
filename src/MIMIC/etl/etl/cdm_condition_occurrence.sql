...
SELECT
    ...
    DATETIME(src.start_datetime)            AS condition_start_datetime,
    CAST(src.end_datetime AS DATE)          AS condition_end_date,
    DATETIME(src.end_datetime)              AS condition_end_datetime,
...
SELECT
    ...
    DATETIME(src.start_datetime)            AS condition_end_datetime,
